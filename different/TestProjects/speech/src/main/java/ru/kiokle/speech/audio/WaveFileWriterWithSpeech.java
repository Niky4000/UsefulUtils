...
public class WaveFileWriterWithSpeech extends SunFileWriter {

    /**
     * Constructs a new WaveFileWriter object.
     */
    public WaveFileWriterWithSpeech() {
...
//            throw new IOException("stream length not specified");
//        }
        return writeWaveFile(stream, waveFileFormat, out, recognizer);
    }
    ...
    private int writeWaveFile(InputStream in, WaveFileFormat waveFileFormat, OutputStream out, BiConsumer<byte[], Integer> recognizer) throws IOException {
