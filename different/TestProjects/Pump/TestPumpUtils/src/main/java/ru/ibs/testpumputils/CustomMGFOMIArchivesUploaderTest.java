...
//            report.setParameters(Arrays.asList(new ReportParameter(ReportParameterType.STRING, "period", "2022-05"), new ReportParameter(ReportParameterType.STRING, "smoMass", "10051,10052,10053,10054,10055,10056,10057,10058")));
            report.setParameters(Arrays.asList(new ReportParameter(ReportParameterType.STRING, "period", "2021-02"), new ReportParameter(ReportParameterType.STRING, "smoMass", "10051,10052,10053")));
