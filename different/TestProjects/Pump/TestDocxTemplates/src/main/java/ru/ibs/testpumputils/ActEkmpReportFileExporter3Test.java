 ...
 * @author me
 */
public class ActEkmpReportFileExporter3Test {

    public static void test() throws Exception {
        String template = "/home/me/VMwareShared/act_ekmp2.docx"; // Прописать свой путь при необходимости!
        String outFile = "/home/me/tmp/reportsPdf/report.docx"; // Прописать свой путь при необходимости!
        ActEkmpReportFileExporter3Test actEkmpReportFileExporter3Test = new ActEkmpReportFileExporter3Test();
        ActEkmpPdfData3 data = actEkmpReportFileExporter3Test.getData(4L);
        byte[] createReport = actEkmpReportFileExporter3Test.createReport(data, template);
        File reportFile = new File(outFile);
    ...
    public byte[] createReport(Object data, String templatePath) throws DocumentException, IOException, XDocReportException {
    ...
    public boolean fillContext(IContext context, FieldsMetadata metadata, Object data) throws XDocReportException {
        if (data != null) {
