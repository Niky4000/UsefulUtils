...
public class FileReader extends Thread {
	...
	public FileReader(String h2DbLocation, String targetDir, int port, boolean deleteExisting) {
		super("FileReader");
				...
				executorService.submit(() -> {
					...
					try (InputStream inputStream = new BufferedInputStream(clientSocket.getInputStream(), BUFFER_SIZE);
						...
						try {
							...
							LOG.log("IOException occured in the Reader thread!", MyLogger.LogLevel.DEBUG);
						}
					}
