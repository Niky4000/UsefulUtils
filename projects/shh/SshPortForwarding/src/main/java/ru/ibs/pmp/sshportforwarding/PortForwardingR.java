...
/**
 * This program will demonstrate the port forwarding like option -R of ssh
 * command; the given port on the remote host will be forwarded to the given
 * host and port on the local side. $ CLASSPATH=.:../build javac
 * PortForwardingR.java $ CLASSPATH=.:../build java PortForwardingR You will be
