 ...
 * @param <T>
 */
public abstract class PmpWordWriter<T extends PdfData> {

	public byte[] createReport(T data) throws DocumentException, IOException,
			XDocReportException {
	...
	public boolean fillContext(IContext context, FieldsMetadata metadata, T data)
