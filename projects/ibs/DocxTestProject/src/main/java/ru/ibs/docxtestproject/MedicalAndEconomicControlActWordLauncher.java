...
public class MedicalAndEconomicControlActWordLauncher {

	public static void start(String[] args, Supplier<SessionFactory> getSessionFactory) throws IOException, ParseException, HibernateException {
		SessionFactory sessionFactory = getSessionFactory.get();
		try {
