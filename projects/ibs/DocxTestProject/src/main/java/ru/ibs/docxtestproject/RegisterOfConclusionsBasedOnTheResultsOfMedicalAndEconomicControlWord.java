...
public class RegisterOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlWord {
	...
	private void createFirstTable(XWPFDocument document, RegisterOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean) {
		...
		createParagraph(table.getRows().get(1).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1TotalServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(1).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1TotalServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(2).getCell(1).getParagraphArray(0), "стационарно", ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(2).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row1ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(2).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row1ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(3).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row2ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(3).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row2ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(4).getCell(1).getParagraphArray(0), "амбулаторно", ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(4).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row3ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(4).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row3ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(5).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row4ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(5).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter1Row4ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(6).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2TotalServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(6).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2TotalServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(7).getCell(1).getParagraphArray(0), "стационарно", ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(7).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row1ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(7).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row1ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(8).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row2ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(8).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row2ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(9).getCell(1).getParagraphArray(0), "амбулаторно", ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(9).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row3ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(9).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row3ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(10).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row4ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(10).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter2Row4ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(11).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3TotalServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(11).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3TotalServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(12).getCell(1).getParagraphArray(0), "стационарно", ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(12).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row1ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(12).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row1ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(13).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row2ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(13).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row2ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(14).getCell(1).getParagraphArray(0), "амбулаторно", ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(14).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row3ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(14).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row3ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(15).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row4ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(15).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter3Row4ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(16).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter4Row1ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(16).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter4Row1ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
		...
		createParagraph(table.getRows().get(17).getCell(2).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter4Row2ServiceCount()), ParagraphAlignment.CENTER, defaultTextSize);
		createParagraph(table.getRows().get(17).getCell(3).getParagraphArray(0), nh(registerOfConclusionsBasedOnTheResultsOfMedicalAndEconomicControlFirstTableBean.getChapter4Row2ServiceSum()), ParagraphAlignment.CENTER, defaultTextSize);
	}
