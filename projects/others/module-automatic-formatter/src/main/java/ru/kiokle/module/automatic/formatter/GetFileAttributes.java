...
//        }
//    }
    public static RevTree getTree(Repository repository, RevCommit commit, Ref branch) throws IOException {
...
//            RevCommit commit = revWalk.parseCommit(lastCommitId);
    ...
    public static void printFile(Repository repository, RevTree tree) throws IOException {
...
//            treeWalk.setFilter(PathFilter.create("README.md"));
            ...
            System.out.println("README.md: " + treeWalk.getPathString() + " " + getFileMode(fileMode) + ", type: " + fileMode.getObjectType() + ", mode: " + fileMode
                    + " size: " + loader.getSize());
        }
    }

    public static void printDirectory(Repository repository, RevTree tree) throws IOException {
