...
/**
 * {@link com.google.googlejavaformat.java.JavaInputAstVisitor JavaInputAstVisitor}
 * outputs a sequence of {@link Op}s using {@link OpsBuilder}. This linear
 * sequence is then transformed by {@link DocBuilder} into a tree-structured
 * {@code Doc}. The top-level {@code Doc} is a {@link
 * Level}, which contains a sequence of {@code Doc}s, including other
 * {@link Level}s. Leaf {@code
 * Doc}s are {@link Token}s, representing language-level tokens; {@link Tok}s,
 * which may also represent non-token {@link Input.Tok}s, including comments and
 * other white-space; {@link Space}s, representing single spaces; and
 * {@link Break}s, which represent optional line-breaks.
 */
public abstract class Doc {

    /**
     * Each {@link Break} in a {@link Level} is either {@link FillMode#UNIFIED}
     * or {@link
     * FillMode#INDEPENDENT}.
     */
    public enum FillMode {
        /**
         * If a {@link Level} will not fit on one line, all of its
         * {@code UNIFIED} {@link Break}s will be broken.
         */
        UNIFIED,
        /**
         * If a {@link Level} will not fit on one line, its {@code INDEPENDENT}
         * {@link Break}s will be broken independently of each other, to fill in
         * the {@link Level}.
         */
        INDEPENDENT,
        /**
         * A {@code FORCED} {@link Break} will always be broken, and a
         * {@link Level} it appears in will not fit on one line.
         */
        FORCED
    }
    ...
    /**
     * Return the width of a {@code Doc}, or {@code Float.POSITIVE_INFINITY} if
     * it must be broken.
     *
     * @return the width
     */
    ...
    /**
     * Return a {@code Doc}'s flat-string value; not defined (and never called)
     * if the (@code Doc} contains forced breaks.
     *
     ...
     *
     * @return the width, or {@code Float.POSITIVE_INFINITY} if it must be
     * broken
     */
    abstract float computeWidth();

    /**
     * Compute the {@code Doc}'s flat value. Not defined (and never called) if
    ...
    static final class Level extends Doc {
        ...
        /**
         * Groups of {@link Doc}s that are children of the current
         * {@link Level}, separated by {@link
         * Break}s.
         */
         ...
         * @return the width, or {@code Float.POSITIVE_INFINITY} if any
         * {@link Doc} must be broken
         */
    ...
    public static final class Token extends Doc implements Op {
        ...
        /**
         * Is a Token a real token, or imaginary (e.g., a token generated
         * incorrectly, or an EOF)?
         */
         ...
         * @param realOrImaginary did this {@link Input.Token} appear in the
         * input, or was it generated incorrectly?
         * @param plusIndentCommentsBefore extra {@code plusIndent} for comments
         * just before this token
    ...
    public static final class Break extends Doc implements Op {
         ...
         * @param flat the text when not broken
         * @param plusIndent extra indent if taken
         * @param optTag an optional tag for remembering whether the break was
         * taken
         * @return the new {@code Break}
         */
